...
python -m MultiModal.multimodal.experiments.run_stage34_semantic_topk \
  --config MultiModal/configs/stage34_semantic_gpu1.yaml 2>&1 | tee "$LOG_DIR/stage34_gpu1.log"
touch "$MARK/gpu1.stage34.done"
echo "[$(date '+%F %T')] queue_semantic_gpu1 complete"
