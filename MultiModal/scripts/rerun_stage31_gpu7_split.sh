...
python -m MultiModal.multimodal.experiments.run_stage31_wavcaps_scaling --config MultiModal/configs/stage31_domain_gap_gpu7_split.yaml 2>&1 | tee "$LOG_DIR/stage31_rerun_gpu7.log"
touch "$MARK_DIR/gpu7.stage31.done"
