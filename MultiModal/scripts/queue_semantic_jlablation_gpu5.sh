...
python -m MultiModal.multimodal.experiments.run_stage34_semantic_topk \
  --config MultiModal/configs/stage34_jlablation_gpu5.yaml 2>&1 | tee "$LOG_DIR/stage34_jlablation_gpu5.log"
touch "$MARK/gpu5.stage34.done"
echo "[$(date '+%F %T')] queue_semantic_jlablation_gpu5 complete"
