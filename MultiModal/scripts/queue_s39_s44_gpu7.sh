...
# Stage 39 rerun on Stage 44 (COCO Phase A) checkpoints — m=512
python -m MultiModal.multimodal.experiments.run_stage39_modality_gap_linear_vs_jl \
  --config MultiModal/configs/stage39_s44_coco_gpu7.yaml 2>&1 | tee "$LOG_DIR/stage39_s44_gpu7.log"

touch "$MARK/gpu7.stage39_s44.done"
echo "[$(date '+%F %T')] queue_s39_s44_gpu7 complete"
