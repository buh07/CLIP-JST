...
log="$LOG_DIR/stage12_ood_concat_gpu7.log"
echo "[$(date '+%F %T')] START stage12_ood_concat"
python -m MultiModal.multimodal.experiments.run_stage12_ood_concat \
  --config MultiModal/configs/stage12_ood_concat.yaml 2>&1 | tee "$log"
echo "[$(date '+%F %T')] DONE stage12_ood_concat"
