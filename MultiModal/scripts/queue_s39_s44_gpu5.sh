...
# Stage 39 rerun on Stage 44 (COCO Phase A) checkpoints — m=128
python -m MultiModal.multimodal.experiments.run_stage39_modality_gap_linear_vs_jl \
  --config MultiModal/configs/stage39_s44_coco_gpu5.yaml 2>&1 | tee "$LOG_DIR/stage39_s44_gpu5.log"

touch "$MARK/gpu5.stage39_s44.done"
echo "[$(date '+%F %T')] queue_s39_s44_gpu5 complete"
