...
python -m MultiModal.multimodal.experiments.run_stage39_modality_gap_linear_vs_jl \
  --config MultiModal/configs/stage39_s44_expand_gpu1.yaml 2>&1 | tee "$LOG_DIR/stage39_s44_expand_gpu1.log"

touch "$MARK_DIR/gpu1.stage39_s44_expand.done"
echo "[$(date '+%F %T')] queue_postw3_stage39_expand_gpu1 complete"
