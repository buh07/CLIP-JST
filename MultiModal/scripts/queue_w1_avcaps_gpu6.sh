...
python -m MultiModal.multimodal.experiments.run_stage57_second_triple_avcaps \
  --config MultiModal/configs/stage57_w1_avcaps_gpu6.yaml 2>&1 | tee "$LOG_DIR/stage57_gpu6.log"

touch "$MARK/gpu6.stage57.done"
echo "[$(date '+%F %T')] queue_w1_avcaps_gpu6 complete"
