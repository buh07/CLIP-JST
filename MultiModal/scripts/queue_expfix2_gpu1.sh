...
python -m MultiModal.multimodal.experiments.run_stage45_quality_quantity_deconfound \
  --config MultiModal/configs/stage45_expfix_clean_source_46k_gpu1.yaml 2>&1 | tee "$LOG_DIR/stage45_clean_source_46k_gpu1.log"

touch "$MARK/gpu1.stage45.done"
echo "[$(date '+%F %T')] queue_expfix2_gpu1 complete"
