...
python -m MultiModal.multimodal.experiments.run_stage34_semantic_topk \
  --config MultiModal/configs/stage34_jlablation_gpu6.yaml 2>&1 | tee "$LOG_DIR/stage34_jlablation_gpu6.log"
touch "$MARK/gpu6.stage34.done"
echo "[$(date '+%F %T')] queue_semantic_jlablation_gpu6 complete"
