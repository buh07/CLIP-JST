...
python -m MultiModal.multimodal.experiments.run_stage57_second_triple_avcaps   --config MultiModal/configs/stage57_w1_lora_gpu2.yaml 2>&1 | tee "$LOG_DIR/stage57_lora_gpu2.log"

touch "$MARK/gpu2.stage57_lora.done"
echo "[$(date '+%F %T')] queue_w1_lora_gpu2 complete"
