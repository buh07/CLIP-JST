...
python -m MultiModal.multimodal.experiments.run_stage34_semantic_topk \
  --config MultiModal/configs/stage34_semantic_gpu2.yaml 2>&1 | tee "$LOG_DIR/stage34_gpu2.log"
touch "$MARK/gpu2.stage34.done"
echo "[$(date '+%F %T')] queue_semantic_gpu2 complete"
