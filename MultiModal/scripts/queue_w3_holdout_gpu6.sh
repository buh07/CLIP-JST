...
python -m MultiModal.multimodal.experiments.run_stage55_wavcaps_holdout_retrain \
  --config MultiModal/configs/stage55_w3_holdout_clean_source_gpu6.yaml 2>&1 | tee "$LOG_DIR/stage55_clean_source_gpu6.log"

touch "$MARK/gpu6.stage55.done"
echo "[$(date '+%F %T')] queue_w3_holdout_gpu6 complete"
