...
python -m MultiModal.multimodal.experiments.run_stage31_wavcaps_scaling --config MultiModal/configs/stage31_domain_gap_gpu6_split.yaml 2>&1 | tee "$LOG_DIR/stage31_rerun_gpu6.log"
