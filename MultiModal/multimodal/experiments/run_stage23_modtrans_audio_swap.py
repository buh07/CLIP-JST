...
def run(cfg: dict) -> None:
    ...
    stage_summary = {
        "stage": "stage23_modtrans_audio_swap",
        "timestamp": time.time(),
    ...
    save_json(stage_summary, output_root / "stage23_summary.json")
    ...
    save_json(provenance, output_root / "provenance_stage23.json")
    mark_done(markers / "stage23_modtrans_audio_swap.done.json", {"elapsed_sec": time.time() - start})
    print("Stage 23 complete")
